    ...
    <section class="px-6 py-6">
        <main class="max-w-lg mx-auto">
            <x-panel>
                ...
                <form method="POST" action="/admin/job/create" class="mt-10">
                    @csrf
                    <div class="grid gap-2 grid-cols-2">
                        <label for="function">Functie: </label>
                        <input class="px-1" name="function" required value="{{old('function')}}" />

                        <label for="description">Beschrijving: </label>
                        <textarea class="px-1" name="description" required value="{{old('description')}}" placeholder="Geef hier een beschrijving van de job."></textarea>
